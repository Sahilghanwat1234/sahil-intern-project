                            ...
                            <Dialog.Panel className="rounded-md bg-white w-6/12">
                                ...
                                <form onSubmit={handleSubmit} className='gap-4 px-8 py-4'>
                                    ...
                                    <div className='mb-2'>
                                        ...
                                        <textarea value={desc} onChange={(e) => setDesc(e.target.value)} className='border border-black-300 rounded-md w-full text-sm py-2 px-2.5 focus:border-indigo-500 focus:outline-offset-1 focus:outline-indigo-400' rows="6" placeholder='Project description'></textarea>
                                    </div>
